...
def fetch_metadata(spec):
    ...
    return finish(spec, selected, adapter="acl_anthology", requests=[receipt(response)], proof="official_acl_anthology_xml_exhausted_and_all_abstracts_present", discovered_count=len(rows))
